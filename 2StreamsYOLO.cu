...
int main() {
    ...
    float* output1;
    cudaMalloc((void**)&output1, outputChannels * outputHeight * outputWidth * sizeof(float));
    float* output2;
    cudaMalloc((void**)&output2, outputChannels * outputHeight * outputWidth * sizeof(float));
    ...
    // Launch YOLOv3-Tiny using two streams
    yolov3Tiny(input, output1, inputChannels, halfInputHeight, inputWidth, outputChannels, outputHeight, outputWidth, stream1);
    yolov3Tiny(input + (inputChannels * halfInputHeight * inputWidth), output2, inputChannels, halfInputHeight, inputWidth, outputChannels, outputHeight, outputWidth, stream2);
    ...
    cudaMemcpy(output1 + (outputChannels * outputHeight * outputWidth / 2), output2, (outputChannels * outputHeight * outputWidth / 2) * sizeof(float), cudaMemcpyDeviceToDevice);
