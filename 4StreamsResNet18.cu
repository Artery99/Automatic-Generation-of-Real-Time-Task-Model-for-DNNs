...
int main() {
    ...
    float* output;
    cudaMalloc((void**)&output, outputClasses * sizeof(float));
    ...
    // Launch RESNET-18 using four streams
    resnet18(input, output, inputChannels, quarterInputHeight, quarterInputWidth, outputClasses, streams[0]);
    resnet18(input + (inputChannels * quarterInputHeight * inputWidth), output + (outputClasses / 4), inputChannels, quarterInputHeight, quarterInputWidth, outputClasses, streams[1]);
    resnet18(input + (inputChannels * quarterInputHeight * inputWidth * 2), output + (outputClasses / 2), inputChannels, quarterInputHeight, quarterInputWidth, outputClasses, streams[2]);
    resnet18(input + (inputChannels * quarterInputHeight * inputWidth * 3), output + (outputClasses * 3 / 4), inputChannels, quarterInputHeight, quarterInputWidth, outputClasses, streams[3]);
