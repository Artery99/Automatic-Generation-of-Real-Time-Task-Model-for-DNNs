...
int main() {
    ...
    // Divide input image into four parts
    int quarterInputHeight = inputHeight / 2;
    int quarterInputWidth = inputWidth / 2;

    // Launch YOLOv3-Tiny using four streams
    yolov3Tiny(input, output, inputChannels, quarterInputHeight, quarterInputWidth, outputChannels, outputHeight, outputWidth, streams[0]);
    yolov3Tiny(input + (inputChannels * quarterInputHeight * inputWidth), output + (outputChannels * outputHeight * outputWidth / 4), inputChannels, quarterInputHeight, quarterInputWidth, outputChannels, outputHeight, outputWidth, streams[1]);
    yolov3Tiny(input + (inputChannels * quarterInputHeight * inputWidth * 2), output + (outputChannels * outputHeight * outputWidth / 2), inputChannels, quarterInputHeight, quarterInputWidth, outputChannels, outputHeight, outputWidth, streams[2]);
    yolov3Tiny(input + (inputChannels * quarterInputHeight * inputWidth * 3), output + (outputChannels * outputHeight * outputWidth * 3 / 4), inputChannels, quarterInputHeight, quarterInputWidth, outputChannels, outputHeight, outputWidth, streams[3]);
